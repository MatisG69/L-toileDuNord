        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <div className="text-2xl font-black text-white">L'Étoile du Nord</div>
                <div className="text-sm text-white/80 font-medium">Boucherie Halal de Qualité</div>
              </div>
            </div>
          ...
          >
            <h3 className="font-bold text-xl text-white mb-6">Navigation</h3>
          ...
          >
            <h3 className="font-bold text-xl text-white mb-6">Contact</h3>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center flex-shrink-0">
                  <MapPin className="w-5 h-5 text-white" />
                </div>
                <div className="text-white/90">
                  <p className="font-semibold text-white mb-1">Adresse</p>
                  <p className="text-sm leading-relaxed">183 Rue des Postes<br />59000 Lille, France</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center flex-shrink-0">
                ...
                <div className="text-white/90">
                  ...
                  <a href="tel:+33679623942" className="text-sm hover:text-white transition-colors">
                    06 79 62 39 42
                  </a>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div className="text-white/90">
                  ...
                  <a href="mailto:contact@etoiledunord.fr" className="text-sm hover:text-white transition-colors break-all">
